...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{multicols}{2}
		...
		Pour commencer, voici comment le menu principal se présente au lancement de l'application (Figure \ref{fig:main_menu}) \\
		...
		Si l'on choisit de se connecter, un formulaire est affiché et donne 3 tentatives d'authentification avant de revenir au menu principal (Fig. 2\ref). \\
		...
		\begin{Figure}
			...
			\captionof{figure}{Ajout d'un patient}
		...
		\begin{Figure}
			...
			\captionof{figure}{Structure en \og couches\fg{} de l'interface}
			\label{fig:structure}
		\end{Figure}
